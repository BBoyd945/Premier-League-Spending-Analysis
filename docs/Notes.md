...
1. There are 2 transfer windows each season but we are only using summer transfer data.
2. Should season performance be split into 2 and only points gained pre jan be counted?
